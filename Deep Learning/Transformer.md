...
네, 그럼요. 기존에 작성하신 5단계 설명에 릴리안 웡 블로그의 2단계 수식 표현을 자연스럽게 통합하여 수정해 드리겠습니다. 기존 설명의 흐름과 가독성을 유지하면서 수식적인 깊이를 더하는 방향으로 구성했습니다.

---

### **수정 제안: 10. 셀프 어텐션의 계산 과정**
...
<div align="center">
  <img src="img/transformer_architecture.webp" width="1000" alt="transformer_architecture">
...
<div align="center">
  <img src="img/transformer_encoder.png" width="800" alt="transformer_encoder">
...
<div align="center">
  <img src="img/transformer_decoder.png" width="800" alt="transformer_decoder">
